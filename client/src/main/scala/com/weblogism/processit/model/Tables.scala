...
trait Tables {
  ...
  case class AccountsRow(id: Long, number: String, customerId: Option[Long] = None)
  ...
  case class CustomersRow(id: Long, name: String)
  ...
  case class TransactionLogsRow(id: Long, payload: Option[String] = None, dateCreated: Option[java.sql.Timestamp] = None)
  ...
  class TransactionLogs(_tableTag: Tag) extends Table[TransactionLogsRow](_tableTag, "transaction_logs") {
  ...
  case class TransactionsRow(id: Long, code: Option[String] = None, dateCreated: Option[java.sql.Timestamp] = None, accountId: Option[Long] = None)
